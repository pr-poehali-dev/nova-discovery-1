    ...
    <div className="min-h-screen bg-background px-6 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-medium text-foreground mb-2">8. Реквизиты компании</h2>
            <p>
              ООО «ЭКСПОНЕЙМ»<br />
              ИНН 9734007616<br />
              КПП 773401001<br />
              ОГРН 1247700731497<br />
              Юридический адрес: 123098, г. Москва, вн.тер.г. муниципальный округ Щукино,
              ул. Рогова, д. 12, помещ. 2П
            </p>
          </section>
        </div>
      </div>
