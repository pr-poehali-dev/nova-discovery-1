    ...
    >
      <div className="max-w-5xl mx-auto relative">
        <h2 className="text-4xl md:text-6xl lg:text-7xl font-serif leading-tight text-center text-foreground/10">
          Стенд — это не конструкция.
          <br />
          Это первое впечатление о бренде.
        </h2>

        {/* Gradient mask reveal text */}
        <motion.h2
          className="absolute inset-0 text-4xl md:text-6xl lg:text-7xl font-serif leading-tight text-center bg-gradient-to-r from-blue-900 via-blue-500 to-blue-900 bg-clip-text text-transparent"
          style={{ clipPath }}
        >
          Стенд — это не конструкция.
          <br />
